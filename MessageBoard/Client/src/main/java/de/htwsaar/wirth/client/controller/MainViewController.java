...
public class MainViewController implements Initializable, MessageObserver {
	...
	public void initialize(URL location, ResourceBundle resources) {
		provider = ClientImpl.getInstance();
		
		messages = FXCollections.observableArrayList(provider.register(this));
    ...
    public void sendMethod(KeyEvent ke) throws IOException {
    	 if (ke.getCode().equals(KeyCode.ENTER)) {
        	provider.sendMessage(messageBox.getText());
        	messageBox.clear();
    	 }
    }
	...
	@Override
	public void notifyEdit(Message ms) {
